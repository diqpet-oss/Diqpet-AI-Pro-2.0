...
export default function App() {
  ...
  const handleDownload = async () => {
    ...
    link.download = `diqpet_${selectedBreedId}_fitting.png`;
    link.click();
  };
            ...
            {loading && (
              <div className="absolute inset-0 z-20 bg-black/60 backdrop-blur-md flex items-center justify-center">
                <div className="flex flex-col items-center gap-4">
                  ...
                  <p className="text-xs font-bold text-orange-500 animate-pulse tracking-widest uppercase italic">AI Processing...</p>
                </div>
              </div>
            )}
            {assets.result ? (
